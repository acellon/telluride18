# Nengo functional amygdala model that receives joy score from AIY via bluetooth
# and sends motor commands to Lego Mindstorm robot via UDP (ev3link).

# This is the code behind the most biologically plausible emotional robot ever
# created....... Amy G. Dala.
